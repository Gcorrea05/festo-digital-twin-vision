  ...
  return (
    <div className="max-w-[1400px] mx-auto px-2 sm:px-4">
      <Card>
        ...
        <CardContent>
          {/* Guias: somente Vibração (mantém layout original) */}
          <Tabs defaultValue="vibracao">
            <TabsList
              className={[
                // mobile: flex centralizado; desktop: grid de 3 colunas centralizada
            ...
            >
              {/* placeholder esquerda (aparece apenas em sm+) */}
              ...
              {/* placeholder direita (aparece apenas em sm+) */}
              <div className="min-w-[8rem] sm:w-full rounded-md px-3 py-2 opacity-0 text-center select-none hidden sm:block" />
            </TabsList>
                  ...
                  {optVib === "vib_runtime" ? (
                    vibRtPoints.length ? (
                      <LineChart data={vibRtPoints}>
                        ...
                        <XAxis
                          dataKey="minute" // igual ao comparativo
